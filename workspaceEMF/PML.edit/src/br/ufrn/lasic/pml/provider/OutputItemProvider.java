...
/**
 * This is the item provider adapter for a {@link br.ufrn.lasic.pml.Output} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PMLPackage.Literals.OUTPUT__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PMLPackage.Literals.OUTPUT__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addSensitivePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Output_sensitive_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Output_sensitive_feature", "_UI_Output_type"),
				 PMLPackage.Literals.OUTPUT__SENSITIVE,
				 true,
				 false,
				 false,
	...
	protected void addLengthPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Output_length_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Output_length_feature", "_UI_Output_type"),
				 PMLPackage.Literals.OUTPUT__LENGTH,
				 true,
				 false,
				 false,
