...
/**
 * This is the item provider adapter for a {@link br.ufrn.lasic.pml.Input} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PMLPackage.Literals.INPUT__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PMLPackage.Literals.INPUT__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addLengthPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Input_length_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Input_length_feature", "_UI_Input_type"),
				 PMLPackage.Literals.INPUT__LENGTH,
				 true,
				 false,
				 false,
	...
	protected void addSensitivePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Input_sensitive_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Input_sensitive_feature", "_UI_Input_type"),
				 PMLPackage.Literals.INPUT__SENSITIVE,
				 true,
				 false,
				 false,
