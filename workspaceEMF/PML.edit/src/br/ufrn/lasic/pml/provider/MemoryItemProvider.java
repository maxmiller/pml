...
/**
 * This is the item provider adapter for a {@link br.ufrn.lasic.pml.Memory} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MemoryItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PMLPackage.Literals.MEMORY__NAME,
				 true,
				 false,
				 false,
	...
	protected void addLengthPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Memory_length_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Memory_length_feature", "_UI_Memory_type"),
				 PMLPackage.Literals.MEMORY__LENGTH,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PMLPackage.Literals.MEMORY__BEHAVIORS_MEMORY);
			childrenFeatures.add(PMLPackage.Literals.MEMORY__INPUT_MEMORY);
			childrenFeatures.add(PMLPackage.Literals.MEMORY__OUTPUT_MEMORY);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PMLPackage.Literals.MEMORY__BEHAVIORS_MEMORY,
				 PMLFactory.eINSTANCE.createBehavior()));

		newChildDescriptors.add
			(createChildParameter
				(PMLPackage.Literals.MEMORY__INPUT_MEMORY,
				 PMLFactory.eINSTANCE.createInput()));

		newChildDescriptors.add
			(createChildParameter
				(PMLPackage.Literals.MEMORY__OUTPUT_MEMORY,
