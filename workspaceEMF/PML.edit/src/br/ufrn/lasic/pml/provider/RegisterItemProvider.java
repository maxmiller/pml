...
/**
 * This is the item provider adapter for a {@link br.ufrn.lasic.pml.Register} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RegisterItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PMLPackage.Literals.REGISTER__NAME,
				 true,
				 false,
				 false,
	...
	protected void addLengthPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Register_length_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Register_length_feature", "_UI_Register_type"),
				 PMLPackage.Literals.REGISTER__LENGTH,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PMLPackage.Literals.REGISTER__BEHAVIOR_REGISTER);
			childrenFeatures.add(PMLPackage.Literals.REGISTER__OUTPUT_REGISTER);
			childrenFeatures.add(PMLPackage.Literals.REGISTER__INPUT_REGISTER);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PMLPackage.Literals.REGISTER__BEHAVIOR_REGISTER,
				 PMLFactory.eINSTANCE.createBehavior()));

		newChildDescriptors.add
			(createChildParameter
				(PMLPackage.Literals.REGISTER__OUTPUT_REGISTER,
				 PMLFactory.eINSTANCE.createOutput()));

		newChildDescriptors.add
			(createChildParameter
				(PMLPackage.Literals.REGISTER__INPUT_REGISTER,
