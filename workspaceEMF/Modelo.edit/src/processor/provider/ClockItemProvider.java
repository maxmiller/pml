...
/**
 * This is the item provider adapter for a {@link processor.Clock} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClockItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Clock_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Clock_value_feature", "_UI_Clock_type"),
				 ProcessorPackage.Literals.CLOCK__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Clock_type") + " " + clock.isValue();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Clock.class)) {
			case ProcessorPackage.CLOCK__VALUE:
