...
/**
 * This is the item provider adapter for a {@link processor.Reset} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ResetItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Reset_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Reset_value_feature", "_UI_Reset_type"),
				 ProcessorPackage.Literals.RESET__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		Reset reset = (Reset)object;
		return getString("_UI_Reset_type") + " " + reset.isValue();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Reset.class)) {
			case ProcessorPackage.RESET__VALUE:
