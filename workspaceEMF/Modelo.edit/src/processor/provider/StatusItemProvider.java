...
/**
 * This is the item provider adapter for a {@link processor.Status} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StatusItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_Status_value_feature", "_UI_Status_type"),
				 ProcessorPackage.Literals.STATUS__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Status_type") + " " + status.isValue();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Status.class)) {
			case ProcessorPackage.STATUS__VALUE:
