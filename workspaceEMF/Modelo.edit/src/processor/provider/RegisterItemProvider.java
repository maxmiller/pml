...
/**
 * This is the item provider adapter for a {@link processor.Register} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RegisterItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Register_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Register_value_feature", "_UI_Register_type"),
				 ProcessorPackage.Literals.REGISTER__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Register_type") + " " + register.getValue();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Register.class)) {
			case ProcessorPackage.REGISTER__VALUE:
