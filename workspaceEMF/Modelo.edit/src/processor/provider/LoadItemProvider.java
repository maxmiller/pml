...
/**
 * This is the item provider adapter for a {@link processor.Load} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LoadItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Load_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Load_value_feature", "_UI_Load_type"),
				 ProcessorPackage.Literals.LOAD__VALUE,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Load_type") + " " + load.isValue();
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Load.class)) {
			case ProcessorPackage.LOAD__VALUE:
