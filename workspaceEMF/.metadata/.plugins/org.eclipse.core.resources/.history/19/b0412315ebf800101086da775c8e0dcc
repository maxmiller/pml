 ...
 * @generated
 */
public class MultiplexadorSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case MultiplexadorPackage.INPUT: {
				Input input = (Input)theEObject;
				T result = caseInput(input);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MultiplexadorPackage.MULTIPLEXER: {
				Multiplexer multiplexer = (Multiplexer)theEObject;
				T result = caseMultiplexer(multiplexer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MultiplexadorPackage.OUTPUT: {
				Output output = (Output)theEObject;
				T result = caseOutput(output);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MultiplexadorPackage.SELETOR: {
